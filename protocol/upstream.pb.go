...
func (x *PIDSet) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PIDSet) ProtoMessage() {}

func (x *PIDSet) ProtoReflect() protoreflect.Message {
	mi := &file_upstream_proto_msgTypes[0]
...
// Deprecated: Use PIDSet.ProtoReflect.Descriptor instead.
func (*PIDSet) Descriptor() ([]byte, []int) {
	return file_upstream_proto_rawDescGZIP(), []int{0}
}

func (x *PIDSet) GetPids() []string {
	if x != nil {
		return x.Pids
	}
	return nil
...
type ProxyRequest struct {
	...
	Messages []*StageMessage `protobuf:"bytes,1,rep,name=messages,proto3" json:"messages,omitempty"`
}
...
func (x *ProxyRequest) GetMessages() []*StageMessage {
	if x != nil {
		return x.Messages
	}
	return nil
...
func (x *ProxyReply) GetTotal() int32 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *StageMessage) GetFrom() string {
	if x != nil {
		return x.From
	}
	return ""
...
func (x *StageMessage) GetTo() string {
	if x != nil {
		return x.To
	}
	return ""
...
func (x *StageMessage) GetMethod() string {
	if x != nil {
		return x.Method
	}
	return ""
...
func (x *StageMessage) GetContent() []byte {
	if x != nil {
		return x.Content
	}
	return nil
...
func (x *FetchRequest) GetMaxSize() int32 {
	if x != nil {
		return x.MaxSize
	}
	return 0
...
type FetchReply struct {
	...
	Batch []*StageMessage `protobuf:"bytes,1,rep,name=batch,proto3" json:"batch,omitempty"`
}
...
func (x *FetchReply) GetBatch() []*StageMessage {
	if x != nil {
		return x.Batch
	}
	return nil
...
var file_upstream_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_upstream_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_upstream_proto_goTypes = []interface{}{
	(*PIDSet)(nil),       // 0: proto.PIDSet
	(*ProxyRequest)(nil), // 1: proto.ProxyRequest
	(*ProxyReply)(nil),   // 2: proto.ProxyReply
	(*StageMessage)(nil), // 3: proto.StageMessage
	(*FetchRequest)(nil), // 4: proto.FetchRequest
	(*FetchReply)(nil),   // 5: proto.FetchReply
	(*Reply)(nil),        // 6: proto.Reply
}
var file_upstream_proto_depIdxs = []int32{
	3, // 0: proto.ProxyRequest.messages:type_name -> proto.StageMessage
	3, // 1: proto.FetchReply.batch:type_name -> proto.StageMessage
	0, // 2: proto.Upstream.RegisterPIDs:input_type -> proto.PIDSet
	1, // 3: proto.Upstream.Proxy:input_type -> proto.ProxyRequest
	4, // 4: proto.Upstream.Fetch:input_type -> proto.FetchRequest
	6, // 5: proto.Upstream.RegisterPIDs:output_type -> proto.Reply
	2, // 6: proto.Upstream.Proxy:output_type -> proto.ProxyReply
	5, // 7: proto.Upstream.Fetch:output_type -> proto.FetchReply
